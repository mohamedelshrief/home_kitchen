...
لا تضف التكييف إلى المجسم قبل قياس: عرض وارتفاع فتحة الدخول، المسافة من أعلى الفتحة للسقف، أبعاد الوحدة الداخلية المحددة، ومسار الصرف والوحدة الخارجية.
...
> اقرأ الملف `ASTRA-HANDOFF.md` كاملًا واعتبره مرجع المشروع الأساسي. افحص النسخة الحالية داخل `kitchen-v2` ولا تبدأ من الصفر. استكمل تصحيح هندسة المطبخ مع الحفاظ على التقسيمة والمقاسات المؤكدة. أولًا راجع خلوص باب التلاجة ووحدة الأجهزة والشباك، ثم أضف خيارًا مبدئيًا لتكييف 1.5 حصان أعلى فتحة الدخول على الحائط الغربي، في مجموعة منفصلة وبأبعاد قابلة للتعديل، من دون ادعاء اعتماده قبل ورود قياسات فتحة الدخول. بعد ذلك صدّر GLB وحدّث الحزمة، ثم أنشئ رندرًا واقعيًا من نفس هندسة وكاميرات المجسم. لا تستخدم صور AI كمصدر للمقاسات ولا تغيّر مواقع البوتاجاز أو الحوض أو التلاجة.
